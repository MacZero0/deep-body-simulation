...
#         input_batch = torch.cat((Zi_init, Zi_minus_1_pred, Wt), 1).float()
...
#         Zi = Z_tensor[new_indices + i]
#         Zi_minus_1 = Z_tensor[new_indices + i - 1]
        
#         # print(Zi_pred.shape)
#         # print(Zi.shape)
#         pos_loss = mae(Zi_pred, Zi)
#         # print(pos_loss)
        
#         Zi_speed_pred = (Zi_pred - Zi_minus_1_pred) / dt
#         Zi_speed = (Zi - Zi_minus_1) / dt
        
#         vel_loss = mae(Zi_speed_pred, Zi_speed)
        
#         Zi_minus_2_pred = Zi_minus_1_pred
#         Zi_minus_1_pred = Zi_pred
        
#         window_loss = pos_loss + vel_loss
